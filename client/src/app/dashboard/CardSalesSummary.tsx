...
const CardSalesSummary = (props: Props) => {
  ...
  return (
    <div className="row-span-3 xl:row-span-6 bg-sky-50 shadow-md rounded-2xl flex flex-col justify-between">
      {(isLoading) ? (
          ...
          <div>
            ...
            <div className="flex justify-between items-center mb-6 px-7 mt-5">
              <div className="text-lg font-medium">
                ...
                <span className="text-2xl font-extrabold">${(totalValueSum / 1_000_000).toLocaleString("en", { maximumFractionDigits: 2 })} m</span>
